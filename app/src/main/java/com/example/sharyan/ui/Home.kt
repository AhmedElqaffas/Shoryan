...
class Home : Fragment(), RequestsRecyclerInteraction, FilterHolder{
    ...
    private fun openDonationFragment(requestId: String){
        val fragment = RequestDetailsFragment.newInstance(requestId,
    ...
    private fun openMyRequestDetailsFragment(requestId: String){
        val fragment = RequestDetailsFragment.newInstance(requestId, RequestDetailsFragment.MY_REQUEST_BINDING)
        fragment.show(childFragmentManager, "requestDetails")
    }
